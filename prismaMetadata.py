...
with h5py.File(filename, 'r')  as f: # file will be closed when we exit from WITH scope
    ...
    SWIRcube = f['HDFEOS/SWATHS/PRS_L1_HCO/Data Fields/SWIR_Cube'][()]#[()] is to get the value. Can be replaced with .value
    VNIRcube = f['HDFEOS/SWATHS/PRS_L1_HCO/Data Fields/VNIR_Cube'][()]
    ...
    lat = f['HDFEOS/SWATHS/PRS_L1_HCO/Geolocation Fields/Latitude_SWIR'][()]
    lon = f['HDFEOS/SWATHS/PRS_L1_HCO/Geolocation Fields/Longitude_SWIR'][()]
